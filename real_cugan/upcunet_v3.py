...
if __name__ == "__main__":
    ...
    # for weight_path, scale in [("updated_weights/up2x-latest-denoise3x.pth", 2),("updated_weights/up4x-latest-denoise3x.pth", 4),]:
        # for tile_mode in [15,12,9,6,3]:#3.6G
        for tile_mode in [0,5]:#3.6G
        # for tile_mode in [5]:#3.6G
        #     for cache_mode in [0,2]:
            for cache_mode in [1]:
        #     for cache_mode in [2]:
        #     for cache_mode in [0]:
